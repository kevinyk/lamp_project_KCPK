...
<?php 
		...
		?>
			...
			<div class="product">
				<a href="/itemDetails/<?=$Wshirt['id']?>"><img id = '<?= $Wshirt['id'] ?>' class="picSize" src="/assets/currentProducts/<?= $Wshirt['front_image_filename']?>" alt="Tee 1" data-alt-src='/assets/currentProducts/<?= $Wshirt['back_image_filename']?>'/></a>
				<h6><?= $Wshirt['name']?></h6>
